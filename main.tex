...
\title{A class definability theorem for Compact Polyhedra}
...
\begin{abstract}
    ...
    its face poset, and the downward closed subposets correspond to closed subpolyhedra.

    We utilize a version of the Goldblatt-Thomason theorem for finite transitive frames,
    which characterizes the modally definable classes as exactly those 
